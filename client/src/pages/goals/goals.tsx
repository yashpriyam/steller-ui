                    ...
                    goalsList.map((data) => (
                        <div className="goals-list-main-wrapper">
                            <div className="goals-data-key-value-wrapper">
                                ...
                                <span className="goals-data-value">{data?.goalType?.goalType}</span>
                            </div>
                            <div className="goals-data-key-value-wrapper">
                            ...
                            <div className="goals-data-key-value-wrapper">
                                ...
                                <span className="goals-data-value">{data.startWeek?.weekNumber}</span>
                            </div>
                            <div className="goals-data-key-value-wrapper">
                                <span className="goals-data-key">End week of Goal</span>
                                <span className="goals-data-value">{data?.endWeek?.weekNumber}</span>
                            </div>
